...
public class BookDAO {
    ...
    private static final String url = "jdbc:mysql://localhost:3306/bookshops1";
    private static final String user = "kmd";
    private static final String pwd = "kmd";
    ...
    public int saveBook(Book book) throws SQLException {
        ...
        String sql = String.format(
                "INSERT INTO books (isbn, title, category, author) VALUES(%s, '%s', '%s', '%s')",
                book.getIsbn(),
                book.getTitle(),
                book.getCategory(),
                book.getAuthor());
    ...
    public List<Book> getBooks(int count) throws SQLException {
        ...
        String sql = "SELECT * FROM books LIMIT count";
        System.out.println(sql);
